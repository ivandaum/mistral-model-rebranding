...
export const COMMERCIAL_MODELS = [
	...
	{
		title: 'Magistral',
		intro: 'Specialized, transparent, and multilingual reasoning.',
		description:
	...
	{
		title: 'Medium 3',
		intro: 'State-of-the-art performance at 8X lower cost.',
		description:
	...
	{
		title: 'Mistral Small',
		intro: 'Enterprise-ready, compact powerhouse.',
		description:
	...
	{
		title: 'Document AI',
		intro: 'Enterprise-grade document processing.',
		description:
	...
	{
		title: 'Codestral',
		intro: 'Elevating code generation.',
		description:
	...
	{
		title: 'Mistral Embed',
		intro: 'Enabling internal semantic search.',
		description: 'State-of-the-art embedding model for semantic search and content organization.',
		link: 'https://docs.mistral.ai/capabilities/embeddings/'
	},
	{
		title: 'Multimodal Models',
		intro: 'Vision pioneer, multimodal mastery.',
		description:
	...
	},
	{
		...
		intro: 'Intelligent content safety at scale.',
		description:
...
export const FREE_MODELS = [
	...
	},
	{
		...
		link: 'https://mistral.ai/news/mistral-small-3-1',
		image:
			'https://mistral.ai/_next/image?url=https%3A%2F%2Fcms.mistral.ai%2Fassets%2F0fb28e38-59a9-487f-ba7c-9eda7de7358a&w=640&q=75'
	},
	{
		title: 'Magistral',
		...
		link: 'https://mistral.ai/news/magistral',
		image:
			'https://mistral.ai/_next/image?url=https%3A%2F%2Fcms.mistral.ai%2Fassets%2F1a2a970b-f183-4549-b497-d65c20bf92ec&w=640&q=75'
	},
	{
		title: 'Voxtral',
		description: 'Audio model with state-of-the-art speech to text capabilities.',
		link: 'https://mistral.ai/news/voxtral',
		image:
